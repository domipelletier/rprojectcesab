...
This research compendium... **{{ was created following https://rdatatoolbox.github.io/chapters/ex-compendium.html }}**



## Features

The main purpose of this compendium is to... **{{work on two datasets PanTHERIA and WildFinder }}**
...
Launch the [`make.R`](https://github.com/domipelletier/rprojectcesab/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/domipelletier/rprojectcesab/blob/main/CONTRIBUTING.md).
